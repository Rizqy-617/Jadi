...
import { bed, bath, amenities, duration} from "data/Filter"
...
export default function Sidebar(props) {
	...
	const handleSubmit = useMutation(async (e) => {
			try {
				...
				console.log("/multiFilter?typeRent=" + durationVal + "&price=" + budgetVal + "&bedroom=" + bedVal + "&bathroom=" + bathVal +'&amenities=["' +
				amenitiesVal.join('","') +
				'"]')
